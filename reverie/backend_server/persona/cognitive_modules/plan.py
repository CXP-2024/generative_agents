...
def _determine_action(persona, maze): 
  ...
  print("\033[0;33mstart one determine action: \033[0m")
  ...
  print("\033[0;33mfinished get a new address: \033[0m", new_address)
  act_pron = generate_action_pronunciatio(act_desp, persona)
  act_event = generate_action_event_triple(act_desp, persona)
  print("\033[0;33mfinished act_event_triple: \033[0m", act_event)
  ...
  print("\033[0;33mfinished act_obj_event: \033[0m", act_obj_event)
  print("\033[0;33mfinished one determine action: \033[0m")
