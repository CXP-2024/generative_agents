...
# Allow ngrok and localhost for development
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '4213-2402-f000-4-1008-809-ffff-fffc-b6a9.ngrok-free.app',
    # Add more ngrok URLs as needed
]

# Alternative: Allow all hosts in development (less secure but more convenient)
# ALLOWED_HOSTS = ['*']
